...
mixin _$HomeController on _HomeControllerBase, Store {
  late final _$cepDataAtom =
      Atom(name: '_HomeControllerBase.cepData', context: context);

  @override
  CepModel? get cepData {
    _$cepDataAtom.reportRead();
    return super.cepData;
  }

  @override
  set cepData(CepModel? value) {
    _$cepDataAtom.reportWrite(value, super.cepData, () {
      super.cepData = value;
    });
  }
  ...
  void clearSearch() {
    final _$actionInfo = _$_HomeControllerBaseActionController.startAction(
        name: '_HomeControllerBase.clearSearch');
    try {
